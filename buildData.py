...
if __name__ == '__main__':
  ...
  nl_unk_threshold = 2
  path_to_data = "./data/stackoverflow/csharp"

  vocab = buildVocab(path_to_data + '/train.txt', code_unk_threshold, nl_unk_threshold, lang)
  get_data(path_to_data + '/train.txt', vocab, False, max_code_len, max_nl_len)
  get_data(path_to_data + '/valid.txt', vocab, False, max_code_len, max_nl_len)
  get_data(path_to_data + '/dev/dev.txt', vocab, True, max_code_len, max_nl_len)
  get_data(path_to_data + '/eval/eval.txt', vocab, True, max_code_len, max_nl_len)
